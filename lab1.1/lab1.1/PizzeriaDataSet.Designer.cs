...
namespace lab1._1.PizzeriaDataSetTableAdapters {
...
SELECT ID_Client, FirstName, SecondName, MiddleName, TypeOfPay FROM Client WHERE (ID_Client = @ID_Client)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::lab1._1.Properties.Settings.Default.PizzeriaConnectionString;
        }
...
SELECT ID_Personal, FirstName, SecondName, MiddleName, Post FROM Personal WHERE (ID_Personal = @ID_Personal)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "DELETE FROM Personal\r\nWHERE  (ID_Personal= @Original_ID_Personal)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
    ...
    public partial class PizzaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "DELETE FROM Pizza\r\nWHERE  (ID_Pizza= @Original_ID_Pizza)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
